...
function install_vim() {
    ...
    # coc.nvim install
    vim -c 'CocInstall -sync coc-emoji coc-go coc-rls coc-typescript coc-emmet coc-snippets coc-lists coc-git coc-vimlsp coc-xml coc-makrdownlint coc-tsserver|q'
}
