...
- Use the active harness's user-global and project-local skill directories; when both define a skill with the same name, prefer the project skill wherever the harness exposes it.
